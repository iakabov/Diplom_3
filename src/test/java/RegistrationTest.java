...
public RegistrationPage registrationPage;
 ...
 private String accessToken; // добавляем поле для хранения токена
...
loginPage = new LoginPage(driver);
 ...
 // удаление перенесено в tearDown()
 }
 ...
 assertTrue("Сообщение о неправильном пароле отображается", actual);
 }
